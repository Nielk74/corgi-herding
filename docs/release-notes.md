An early playable prototype of Corgi Herding: two herders, two shared corgis and ten sheep in one meadow.

Install `corgi-herding.apk` on Android. Both players use the same server address: one creates a herd and shares its invite code, the other joins. Tap the meadow to walk, choose Mochi or Maple to give Come/Stay/Go commands, and open the gate when nearby. There is no score or timer.
