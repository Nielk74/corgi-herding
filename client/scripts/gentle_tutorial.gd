...
const COPY := {
	...
	"stay": ["Ask your corgi to Stay.", "They can hold a helpful spot while you move."],
	"place": ["Send your corgi to some grass, or drag them there.", "Where a dog stands matters more than speed."],
