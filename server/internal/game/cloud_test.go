...
func TestCloudCanonicalGeometryAndAnalyticVoidRejection(t *testing.T) {
	...
	if w.SupportsLayout(3) || !w.SupportsLayout(4) || !w.SupportsLayout(5) || !w.SupportsLayout(6) || !w.SupportsLayout(7) || !w.SupportsLayout(8) || w.SupportsLayout(9) || w.SupportsLayout(99) {
